...
kw=  {'path': r"F:\lxj\研究\code\mycode-PPTPP\data\trainsets",}
fastas1 = readFasta.readFasta(r"F:\lxj\研究\code\mycode-PPTPP\data\trainsets\SBP_1.txt")

result=BLOSUM62(fastas1, **kw)
data1=np.matrix(result[1:])[:,1:]
data_=pd.DataFrame(data=data1)
data_.to_csv('BLOSUM62_SBP_train.csv')
