...
def KNNpeptide(fastas, **kw):
	...
	return encodings
fastas = readFasta.readFasta(r"F:\lxj\研究\code\mycode-PPTPP\data\\AIP_test.txt")
kw=  {'path': r"F:\lxj\研究\code\mycode-PPTPP\data",'train':r"F:\lxj\研究\code\mycode-PPTPP\data\AIP_test.txt",'label':r"F:\lxj\研究\code\mycode-PPTPP\data\label_AIP_test.txt",'order':'ACDEFGHIKLMNPQRSTVWYO'}
